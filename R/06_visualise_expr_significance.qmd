...
most_upreg |> 
  ggplot(aes(x = 1, y = fct_inorder(SYMBOL), fill = mean_log2_expr_change)) +
  geom_tile() +  # This creates the tiles for the heatmap
  geom_text(aes(label = mean_log_2_expr_change), color = "black", size = 3) +  # Adds the text labels on top of the tiles
