...
```{r}
# Loading the data
path_gene = "../data/_raw/GSE151243_Raw_gene_counts_matrix.txt.gz"
path_meta = "../data/_raw/GSE151243_series_matrix.txt.gz"
gene_table <- read_table(path_gene, col_names = TRUE)
meta_table <- read_table(path_meta, skip = 33, na = 'NA', col_names = TRUE)
```
...
write_tsv(final_table, file = "../data/meta_gene_table.tsv.gz")
```
